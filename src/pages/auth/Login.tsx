...
export default function Login() {
    ...
    return (
        <AuthLayout title={t("Sign in")} heading={t("Sign in to your account")}>
                ...
                <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
                    <form className="space-y-6" method="POST">
                        <TextBox id="email"
                                 ...
                                 labelClass="sr-only"
                                 required
                                 onChange={form?.getField("email")?.onChange}
                                 error={form?.getField("email")?.isInvalid}
                                 message={form?.getField("email")?.errorBag[0]}
                        ...
                        <TextBox id="password"
                                 ...
                                 labelClass="sr-only"
                                 required
                                 onChange={form?.getField("password")?.onChange}
                                 error={form?.getField("password")?.isInvalid}
                                 message={form?.getField("password")?.errorBag[0]}
